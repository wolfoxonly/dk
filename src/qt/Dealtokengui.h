...
/**
  Dealtoken GUI main class. This class represents the main window of the Dealtoken UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class DealtokenGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit DealtokenGUI(QWidget *parent = 0);
    ~DealtokenGUI();
