...
const QString BITCOIN_IPC_PREFIX("Dealtoken:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Dealtoken: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Dealtoken: click-to-pay handler");
    else
...
{
    // clicking on Dealtoken: URLs creates FileOpen events on the Mac:
