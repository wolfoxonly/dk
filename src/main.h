...
static const int STAKE_MIN_AGE = 60 * 60 * 24 * 14; // minimum age for coin age<zxb>
...
static const uint256 hashGenesisBlockOfficial("0x000000ce5c54efbc6170fd9ac5e17352a54c21b57ecd76f187938afecea89f51");
...
int64 GetProofOfStakeReward(int64 nCoinAge,int64 balance = 0);
...
#ifdef TESTING
void DealtokenMiner(CWallet *pwallet, bool fProofOfStake, bool fGenerateSingleBlock = false);
#else
...
public:
    ...
    */
    ...
    /** Amount of Dealtokens spent by this transaction.
    ...
    /** Amount of Dealtokens coming in to this transaction
...
public:
    ...
    /**
     * Duplicate from Dealtokenrpc that originaly define this method.
