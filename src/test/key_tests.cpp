...
static const CDealtokenAddress addr1 ("PKkaDEczLygWFN1C3ccEGraLshKMMEoBgn");
static const CDealtokenAddress addr2 ("PXYTm8BcoygtXB7VrAn77DeXhXCNSxxwsW");
static const CDealtokenAddress addr1C("PJC1cL5mBMKmQ357ZNMDVAWH5sDVJNX3p8");
static const CDealtokenAddress addr2C("P95CZ3kFgAvjnMdRgqLoApDuQ49ir7VAP7");
...
void dumpKeyInfo(uint256 privkey)
{
    ...
    for (int nCompressed=0; nCompressed<2; nCompressed++)
    {
        ...
        printf("    * address (base58): %s\n", CDealtokenAddress(vchPubKey).ToString().c_str());
    }
}
#endif
...
{
    CDealtokenSecret bsecret1, bsecret2, bsecret1C, bsecret2C, baddress1;
