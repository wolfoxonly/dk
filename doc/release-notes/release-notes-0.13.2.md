Dealtoken Core version 0.13.2 is now available from:

  <https://Dealtoken.org/bin/Dealtoken-core-0.13.2/>
...
- #8908 `4a974b2` Update Dealtoken-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow Dealtoken-tx to create v2 transactions (btcdrak)
