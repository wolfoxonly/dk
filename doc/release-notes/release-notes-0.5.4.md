Dealtoken version 0.5.4 is now available for download at:
http://sourceforge.net/projects/Dealtoken/files/Dealtoken/Dealtoken-0.5.4/
...
http://gitorious.org/Dealtoken/Dealtokend-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Dealtoken-Qt notifications under Growl 1.3.
Increase required age of Dealtoken-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxDealtoken properly when installing Dealtoken-Qt over it. (Windows)
