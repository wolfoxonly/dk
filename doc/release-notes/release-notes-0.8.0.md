Dealtoken-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/Dealtoken/files/Dealtoken/Dealtoken-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Dealtoken
...
New/changed settings (command-line or Dealtoken.conf file)
--------------------------------------------------------
