Dealtoken Core version 0.14.2 is now available from:

  <https://Dealtoken.org/bin/Dealtoken-core-0.14.2/>
...
(in Dealtoken Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in Dealtoken-Qt when using coin
...
- #10228 `ae479bc` Regenerate Dealtoken-config.h as necessary (theuni)
