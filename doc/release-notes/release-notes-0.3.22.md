Download URL: https://sourceforge.net/projects/Dealtoken/files/Dealtoken/Dealtoken-0.3.22/
...
* IRC is overflowing.  Client now bootstraps to channels #Dealtoken00 - #Dealtoken99
