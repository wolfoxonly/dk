Dealtoken Core version 0.10.4 is now available from:

  <https://Dealtoken.org/bin/Dealtoken-core-0.10.4/>
...
- #6953 `43c2789` Split Dealtoken-tx into its own package
- #6953 `dfe0d4d` Include Dealtoken-tx binary on Debian/Ubuntu
