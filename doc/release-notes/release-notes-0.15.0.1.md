Dealtoken Core version *0.15.0.1* is now available from:

  <https://Dealtoken.org/bin/Dealtoken-core-0.15.0.1/>

and

  <https://Dealtokencore.org/bin/Dealtoken-core-0.15.0.1/>
