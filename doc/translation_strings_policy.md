...
This document provides guidelines for internationalization of the Dealtoken Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `Dealtoken_en.ts` remains unchanged.
