...
* Dealtoken.conf: contains configuration settings for Dealtokend or Dealtoken-qt
* Dealtokend.pid: stores the process id of Dealtokend while running
...
* debug.log: contains debug information and general logging generated by Dealtokend or Dealtoken-qt
