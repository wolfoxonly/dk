...
By default, Dealtokend will dump mempool on shutdown and
...
class MempoolPersistTest(DealtokenTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(1)
        self.start_node(2)
        # Give Dealtokend a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent Dealtokend from writing mempool.dat to disk. Verify that `savemempool` fails")
