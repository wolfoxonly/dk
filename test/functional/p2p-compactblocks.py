...
# TestNode: A peer we use to send messages to Dealtokend, and store responses.
...
class CompactBlocksTest(DealtokenTestFramework):
    ...
    # This test actually causes Dealtokend to (reasonably!) disconnect us, so do this last.
    ...
    # Test that Dealtokend requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for Dealtokend to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # Dealtokend will not send blocktxn responses for blocks whose height is
